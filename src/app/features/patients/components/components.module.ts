...
} from './card-patient-detail/card-patient-detail.component';
import {
  CardPatientInfoComponent
} from './card-patient-info/card-patient-info.component';
...
} from './table-appointment/table-appointment.component';
